              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-4">
                {trendingMovies.map((movie) => (
                  ...
                  >
                    ...
                    {isComingSoon(movie) && (
                      <span className="absolute top-3 right-3 z-20 bg-amber-500 text-[9px] text-white font-black tracking-widest px-2.5 py-0.5 rounded-lg shadow-md uppercase">Coming Soon</span>
                    )}
                    <div className="w-full aspect-[3/3] bg-neutral-900 relative overflow-hidden">
                      <img
                ...
                {topTenMovies.map((movie, index) => (
                  ...
                  >
                    ...
                    <div className="relative z-10 bg-neutral-900 rounded-2xl overflow-hidden shadow-md aspect-[2/3] border border-white/10">
                      {isComingSoon(movie) && (
                        <span className="absolute top-2 right-2 z-20 bg-amber-500 text-[8px] text-white font-black tracking-widest px-1.5 py-0.5 rounded uppercase">Soon</span>
                      )}
                      <img
                        src={(movie.poster && movie.poster.trim() !== "") ? movie.poster : FALLBACK_POSTER}
                ...
                {displayRecommended.map((movie) => (
                  ...
                  >
                    <div>
                      ...
                      {isComingSoon(movie) && (
                        <span className="absolute top-3 right-3 z-20 bg-amber-500 text-[7px] text-white font-black px-1.5 py-0.5 rounded shadow-sm uppercase tracking-wider">Soon</span>
                      )}
                      <div className="w-full aspect-[2.5/3] bg-neutral-900 rounded-xl overflow-hidden relative shadow-inner">
                        <img
                          src={(movie.poster && movie.poster.trim() !== "") ? movie.poster : FALLBACK_POSTER}
                          alt={movie.title}
