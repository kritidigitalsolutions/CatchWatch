...
const SearchMoviesPage = () => {
  ...
  const [contentCollection] = useState([
    { id: "s1", image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDeS7hPZyNrisDyiQkUQR2pqwxE9fdKjgF5og5GHSiEjR02xQ9C-0__kpC&s=10', title: "Rugna The Film", category: "Movie", year: "2022" },
    { id: "s2", image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDeS7hPZyNrisDyiQkUQR2pqwxE9fdKjgF5og5GHSiEjR02xQ9C-0__kpC&s=10', title: "bab INT Low res", category: "Movie", year: "2022" },
    { id: "s3", image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDeS7hPZyNrisDyiQkUQR2pqwxE9fdKjgF5og5GHSiEjR02xQ9C-0__kpC&s=10', title: "ADITC-PART1", category: "Movie", year: "Production" },
    { id: "s4", image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDeS7hPZyNrisDyiQkUQR2pqwxE9fdKjgF5og5GHSiEjR02xQ9C-0__kpC&s=10', title: "The Past", category: "Movie", year: "2018" },
    { id: "s5", image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDeS7hPZyNrisDyiQkUQR2pqwxE9fdKjgF5og5GHSiEjR02xQ9C-0__kpC&s=10', title: "ADITC-PART2", category: "Movie", year: "Production" },
  ]);
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-lg bg-gray-200 text-gray-400 flex items-center justify-center text-xl font-bold shadow-inner">
                  <img src={item.image} alt={item.title} className="w-full h-full object-cover rounded-lg" loading="lazy"/>
                  
                </div>
                <div>
                  <div className="text-sm font-bold text-gray-800 group-hover:text-brand-orange transition">
                    {item.title}
                  </div>
