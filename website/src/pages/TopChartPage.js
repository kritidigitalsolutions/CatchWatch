        ...
        {topTenItems.map((item, index) => {
          ...
          return (
            <div 
              ...
              className="flex items-center justify-between p-3 sm:p-4 bg-gray-50/50 hover:bg-orange-50/50 border border-gray-100 rounded-xl transition group cursor-pointer"
            >
