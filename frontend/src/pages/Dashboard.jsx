...
const COLORS = ["#FF7A1A", "#3b82f6", "#10b981", "#f59e0b"];
    ...
    <div className="page-section">
      ...
      <div className="pg-header">
        <div>
          ...
          <p className="pg-sub">Real-time stats and analytics for CatchWatch</p>
        </div>
        ...
        <div className="content-box">
          ...
          <ResponsiveContainer width="100%" height={260}>
            <AreaChart data={GROWTH} margin={{ top: 8, right: 12, left: -18, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="users" stroke="#FF7A1A" strokeWidth={2.5}
                fill="url(#redGrad)"
                activeDot={{ r: 6, fill: "#FF7A1A", stroke: "var(--bg2)", strokeWidth: 3 }} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
